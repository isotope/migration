...
return array(
    ...
    'summary' => array(
        ...
        'next1'               => <<<'HTML'
<p>Melde dich im Contao Backend an und gehe zur Erweiterungsverwaltung. Danach deaktiviere den Safe-Mode über die rote Leiste im Header (oder über System -> Einstellungen -> Globale Einstellungen -> Abgesicherter Modus).</p>
<p class="explain">Bleibe <strong>nicht</strong> auf der Backend-Startseite, diese funktioniert nicht solange Isotope nicht aktualisiert ist!</p>
HTML
        ,
        'next2'               => <<<'HTML'
...
HTML
        ...
        'mail_template' => array(
            'service_name'        => 'E-Mail Templates',
            'service_description' => 'Migriert die E-Mail Templates in das Benachrichtigungszentrum.',
            'gateway_legend'      => 'E-Mail Gateway',
            'gateway_intro'       => 'Wähle eines der verfügbaren E-Mail Gateways aus dem Benachrichtigungszentrum oder erstelle ein neues Gateway für die E-Mail Template Migration.',
            'gateway_new'         => 'Erstelle ein neues E-Mail Gateway',
            'gateway_db'          => 'Gateways deiner Datenbank',
            'orderstatus'         => 'Bestellstatus "%name%"',
            'checkoutmodule'      => 'Kassenmodul "%name%"',
        ...
        'payment_method' => array(
            ...
            'old_description'     => 'Wir werden diese Daten nicht verändern. Eventuell findest du eine Erweiterung eines Drittanbieters oder fragst den Entwickler deines Vertrauens, dies für dich zu beheben.',
            'unknown_title'       => 'Unbekannte Zahlungsarten',
            'unknown_explain'     => 'Folgende Zahlungsarten scheinen aus einer Drittanbieter-Erweiterung zu stammen:',
            'unknown_description' => 'Wir können weder sagen, ob sie in Isotope 2 funktionieren, noch deren Daten migrieren. Daher verändern wir diese Daten nicht, damit dir ein Entwickler eine Update-Möglichkeit bieten kann.',
            'confirmation'        => 'Bitte bestätige, dass du das Obenstehende gelesen hast. Es liegt in deiner Verantwortlichkeit, keine der alten/nicht mehr unterstützen Zahlungsarten zu verändern, wenn du sie in Zukunft weiterhin nutzen möchtest.'
        ),
        'product_collection' => array(
            'service_name'        => 'Produktsammlungen',
            'service_description' => 'Migriert die Bestellinformationen',
            'legend'              => 'Aufpreise',
            'intro'               => 'Bitte nenne uns, welche Arten von Aufpreisen existieren.',
            'description' => <<<'HTML'
<p class="explain">Jede Bestellung kann in Isotope eine unbeschränkte Anzahl an Aufpreisen enthalten. Das kann ein Aufpreis für Zahlungs-, Versandarten oder Ähnliches sein.
...
<p class="explain">In den meisten Fällen kannst du einfach den Titel anwählen und du wirst sehen, wohin der Aufpreis zugeordnet werden sollte.
Falls du Drittanbieter-Erweiterungen genutzt hast, die eigene Aufpreise hinzufügen, frag bitte den Entwickler welchen Typ diese Aufschläge benötigen.
...
HTML
        ...
        'shipping_method' => array(
            ...
            'old_description'     => 'Wir werden diese Daten nicht verändern. Eventuell findest du eine Drittanbieter-Erweiterung oder fragst den Entwickler deines Vertrauens, dies für dich zu beheben',
            'unknown_title'       => 'Unbekannte Versandarten',
            'unknown_explain'     => 'Die folgenden Versandarten scheinen aus einer Drittanbieter-Erweiterung zu stammen:',
            'unknown_description' => 'Wir können weder sagen, ob sie in Isotope 2 funktionieren, noch deren Daten migrieren. Daher verändern wir diese Daten nicht, damit dir ein Entwickler eine Update-Möglichkeit bieten kann.',
            'confirmation'        => 'Bitte bestätige, dass du alles Obenstehende gelesen hast. Es liegt in deiner Verantwortlichkeit, keine der alten/nicht mehr unterstützen Versandarten zu verändern, wenn du sie in Zukunft weiterhin nutzen möchtest'
        ),
        'shop_config' => array(
        ...
        'rule' => array(
            'service_name'        => 'Regeln',
            'service_description' => 'Migriert Regeln.',
        ),
    )
);
